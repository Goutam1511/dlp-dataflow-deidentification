...
public abstract class WriteToLocal extends PTransform<PCollection<KV<String, Table.Row>>, WriteFilesResult<String>> {
    ...
    public static Builder newBuilder() {
        return new AutoValue_WriteToLocal.Builder();
    }
    ...
    public abstract static class Builder {
        ...
        public abstract WriteToLocal build();
    }
